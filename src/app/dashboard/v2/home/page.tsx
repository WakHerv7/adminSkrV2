...
export default function Home() {
	...
	return (
      ...
      <></>
            ...
            subtitle={transactionTrendsGraphData?.labels?.length >0  ? 
              `${transactionTrendsGraphData?.labels?.[0]} - ${transactionTrendsGraphData?.labels?.[transactionTrendsGraphData?.labels?.length-1]}`:'Chargement ...'}
          ...
          :
              ...
              ...Object.keys(periods).map((pkey, pindex) => (
                <div 
                  ...
                  onClick={() => dispatch(setPeriod(pkey))}
                >
