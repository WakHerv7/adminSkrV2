  ...
  return (
    <section className="p-6">
      <div className="w-full flex justify-start items-center">
        <div className="pr-10">
          <h1 className="text-sm font-semibold mb-2">Nombre de transferts <span className="text-base font-semibold text-[#18BC7A] ml-5">88</span></h1>
