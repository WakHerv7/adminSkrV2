...
export { headerTransactionData, headerCardTransactionData, headerTransferData } from "./TransactionData";
...
export const kycRejectReasons:any = {
	...
	"FACE_PREVIOUSLY_ONBOARDED": "Visage du selfie correspond à un autre utilisateur",
	"MISSING_NAME": "Absence du nom sur le document",
	"MISSING_DOCUMENT_NUMBER": "Absence du numero d'identification sur le document",
	"FACE_LIVENESS_TOO_FAR_FROM_CAMERA": "Visage trop loin de la camera",	
	"FACE_MISMATCH": "Incompatibilité entre le visage du selfie et celui du document",	
	"NAME_MISMATCH": "Incompatibilité entre le nom fourni et celui du document",
	"BIRTHDATE_MISMATCH": "Incompatibilité entre la date de naissance fournie et celle du document",
	"DOCUMENT_NUMBER_MISMATCH": "Incompatibilité entre le numero d'identification fourni et celui du document",
