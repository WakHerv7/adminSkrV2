...
import { selectCurrentGetSekureApiToken, selectCurrentUser, setCredentials } from "@/redux/slices/auth";
        ...
        <form onSubmit={form.handleSubmit(onSubmit, onError)}>
            <div className="space-y-[20px]">
                ...
                render={({ field }) => (
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <span className='text-xs text-gray-500'>{`${getFormLabels(amount?.toLocaleString('fr-FR'))?.note}`}</span>
                    <FormControl>
                        <Input 
                        type="number" 
                        min={0}
                        max={Math.floor(amount) ?? 1000000000000000000000000 }
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        ...
                        >
                        {phoneData.map((item:any,idx:any) => (
