...
import { IoCopyOutline } from 'react-icons/io5';
  ...
  const infoData: TDataList[] = [
    [
        ...
        [{
            key: 'name',
            label:{text: 'Nom expéditeur', fw:"bold", color:"#444"},
            value:{text:"ATEBA Jean", color:"#444"}
        }],
        [{
            key: 'country',
            label:{text: 'Pays exp.', fw:"bold", color:"#444"},
            value:{text:"Gabon", color:"#444"}
        }],
        [{
            key: 'phone',
            label:{text: 'Telephone exp.', fw:"bold", color:"#444"},
            value:{text:"+237 699 58 62 35", color:"#444"}
        }],
        [{
            key: '',
            label:{text: 'Nom destinataire', fw:"bold", color:"#444"},
            value:{text:"Ferdinand MOOL", color:"#444"}
        }],
        [{
            key: '',
            label:{text: 'Pays dest.', fw:"bold", color:"#444"},
            value:{text:"Gabon", color:"#444"}
        }],
        [{
            key: '',
            label:{text: 'Telephone dest.', fw:"bold", color:"#444"},
            value:{text:"+237 676 88 22 55", color:"#444"}
        }],
