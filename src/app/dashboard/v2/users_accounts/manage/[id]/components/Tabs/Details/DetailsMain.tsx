...
export default function Details() {
  ...
  const form = useForm<z.infer<typeof detailsSchemaV2>>({
    ...
    defaultValues: {
      ...
      first_name: customerDetails?.customer?.first_name ? `${customerDetails?.customer?.first_name}` : "",
      last_name: customerDetails?.customer?.last_name ? `${customerDetails?.customer?.last_name}` : "",
      ...
      age: calculateAge(parseDateStr(customerDetails?.customer?.birthdate ?? "")), //String(customerDetails?.customer?.age ?? ""),
      ...
      additionalPhoneNumbers: customerDetails?.customer?.additional_phone_numbers ??[],
  ...
  const handleEditMode = (value: any) => {
    ...
    if(value) {
      ...
      form.setValue('first_name',customerDetails?.customer?.first_name ?? "");
      form.setValue('last_name',customerDetails?.customer?.last_name ?? "");
      ...
      form.setValue('codeParrain',customerDetails?.customer?.sponsor_code ?? "");
      form.setValue('codeParrainage',customerDetails?.customer?.sponsorship_code ?? "");
      form.setValue('deviceModel',customerDetails?.customer?.device_model ?? customerDetails?.customer?.deviceModeled ?? "");
      form.setValue('deviceID',customerDetails?.customer?.device_id ?? "");
      form.setValue('idNumber',customerDetails?.customer?.id_document_umber ?? "");
      form.setValue('idPaper',customerDetails?.customer?.id_document_type ?? "");
      form.setValue('age',calculateAge(parseDateStr(customerDetails?.customer?.birthdate ?? "")));
      form.setValue('idExpDate',String(customerDetails?.customer?.id_expiry_date ?? ""));
      form.setValue('birthday',customerDetails?.customer?.birthdate ?? "");
      ...
      form.setValue('additionalPhoneNumbers',customerDetails?.customer?.additional_phone_numbers ?? []);
    }
	};
              ...
              <div className="w-full flex flex-col gap-7">
                ...
                <FormField
                  ...
                  <FormItem>
                    ...
                    {customerDetails?.customer?.id_document_front?.startsWith('http') ?
                        <Image
                            alt='vector background'
                            src={customerDetails?.customer?.id_document_front }
                            layout='fill'
                            objectFit='contain'
                        />
                        :
                  ...
                  <FormItem>
                    ...
                    <div style={{width: '100%', height: 400, borderRadius:'20px', position: 'relative'}}>
                        {customerDetails?.customer?.id_document_back?.startsWith('http') ?
                        <Image
                            alt='vector background'
                            src={customerDetails?.customer?.id_document_back }
                            layout='fill'
                            objectFit='contain'
                        />
                        :
                  ...
                  <FormItem>
                    ...
                    <div style={{width: '100%', height: 400, borderRadius:'20px', position: 'relative', overflow:'hidden'}}>
                        {customerDetails?.customer?.id_selfie?.startsWith('http') ?
                        <Image
                            alt='vector background'
                            src={customerDetails?.customer?.id_selfie }
                            layout='fill'
                            objectFit='contain'
                        />
                      :
