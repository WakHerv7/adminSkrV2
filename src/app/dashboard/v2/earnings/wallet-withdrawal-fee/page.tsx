...
const getAllTrx = async ({ queryKey }: any) => {
	...
	params.includedCategories = "wallet";
	params.includedTypes = "withdrawl.standbypayout";
...
export default function Index() {
	useTitle("Wallet | Withdrawal fees", true);
	...
	return (
		<Layout title={"Frais de retrait de compte"}>
			<>
