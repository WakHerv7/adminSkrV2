...
function SearchUserInput({onSelected}: IProps) {
    ...
    return (
        ...
        className={`w-full border border-gray-200 bg-[#F4EFE3] text-gray-900 font-normal rounded-md px-4 py-2`}
        ...
        {showPicker && query?.length > 2 ?
            ...
            style={{position:'absolute', zIndex:'1000', top:'50px', left:'0', width:'100%', display:results?.length ? 'block': 'none'}}
            >
                {mutation.isLoading ?
                ...
                <ul>
                    ...
                    style={{borderTop: index>0 ? '1px solid #eee' : ''}}>
