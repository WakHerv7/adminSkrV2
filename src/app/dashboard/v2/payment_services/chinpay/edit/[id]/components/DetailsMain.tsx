...
export default function Details() {  
  ...
  const form = useForm<z.infer<typeof chnpaymentSchema>>({
      ...
      defaultValues: {
        ...
        platform_profile_id: chnPaymentData?.chnpayment?.platform_profile_id,
        provider_payment_link: chnPaymentData?.chnpayment?.provider_payment_link,
              ...
              <div className="pr-6 flex-1 w-full">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="px-6 font-normal bg-gray-200" {...field} />
                      </FormControl>
                    </FormItem>
                  )}
                />
                <div className="grid grid-cols-2 gap-x-7 gap-y-7 mt-5">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input className="px-6 bg-gray-200" {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="abc@sekure.xyz" className="px-6 font-normal bg-gray-200" {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                    />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-900 text-sm font-semibold tracking-tight">Ville</FormLabel>
                        <FormControl>
                          <Input className="px-6 bg-gray-200" {...field} />
                        </FormControl>
                      </FormItem>
                  ...
                  <div className="grid grid-cols-2 gap-x-7 gap-y-7">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <div className="flex gap-5">
                            ...
                            {form.getValues('product_link')?.startsWith('http') && 
                            <a href={form.getValues('product_link')} target="_blank" rel="noopener noreferrer">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <div className="flex gap-5">
                            ...
                            {form.getValues('provider_payment_link')?.startsWith('http') && 
                            <a href={form.getValues('provider_payment_link')} target="_blank" rel="noopener noreferrer">
                              <FaExternalLinkAlt color="#18BC7A"/>
                            </a>}
                          </div>
                          <FormControl>
                    ...
                    <FormItem>
                      ...
                      <div style={{position: 'relative'}}>
                        {chnPaymentData?.chnpayment?.proof?.startsWith('http') ?
                          <>
                            {chnPaymentData?.chnpayment?.proof?.includes('proof-image') ?
                              <div className="mt-3" style={{width: 400, height: 400, borderRadius:'20px', position: 'relative', overflow:'hidden'}}>
                                <Image
                                    alt='vector background'
                                    src={chnPaymentData?.chnpayment?.proof }
                                    layout='fill'
                                    objectFit='cover'
                                />
                                <a 
                                style={{top:0, left:0, width: 400, height: 400, borderRadius:'20px', position: 'absolute', overflow:'hidden'}}
                                href={chnPaymentData?.chnpayment?.proof} target="_blank" rel="noopener noreferrer">                                
                                </a>
                              </div>
                              :
                              <a className={`my-5 ml-[100px]`} href={chnPaymentData?.chnpayment?.proof} target="_blank" rel="noopener noreferrer">
                                <FaFile size={60} color="#18BC7A"/>
                              </a>
                            }
                          ...
                          <CButton
                          text={'Inserer une preuve de paiement'} 
                          btnStyle={'green'}
                          onClick={()=>setIsUpdateProofModalFormOpen(true)}                          
                          />
                          </>
                      ...
                      <UpdateProofModalForm
                        ...
                        setIsOpen={setIsUpdateProofModalFormOpen}
                        chnPayment={chnPaymentData?.chnpayment}
                      />
