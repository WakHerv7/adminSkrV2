                    ...
                    line.forEach((x, xIndex) => {
                        if (key.toString() === String(x.key)) {
                            if (key.toString() === 'name') {
                                ...
                                x.value.text = recipient?.name;
                                if(itm.category !== 'transfert' || itm.type !== 'transfert') x.visible = false;
                            }
                                ...
                                x.value.text = recipient?.pays;
                                if(itm.category !== 'transfert' || itm.type !== 'transfert') x.visible = false;
                            }

                            else if (key.toString() === 'cardNumber') {
                                if(itm.cardDetails) x.value.text = itm.cardDetails?.maskedNumber;
                                if(itm.category === 'transfert' && itm.type === 'transfert') x.visible = false;
                            }
            ...
            {itemData(item, infoData, customer).map((data, index) => (
                ...
                {data.map((line, index1) => (
                    ...
                    {line.map((item, index2) => (                        
                        <div key={index2} style={{display:item.visible?'flex':'none'}} className={`my-3 grid grid-cols-2 gap-3 w-full`}>
