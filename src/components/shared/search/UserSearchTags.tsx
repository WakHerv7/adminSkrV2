...
export const UserSearchTags = ({ field, tags, onChange, addTag, removeTag, max=2 }: iTag) => {
  // track the use input
  // console.log("TagField field : ", field);
  const [placeholder, setPlaceholder] = useState<string>("Ajouter un élément");
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <SearchUserInput
      onSelected={(data)=>handleAddTag(data)}/>
      {/* <input
