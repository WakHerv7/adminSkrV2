...
const getAllCustomerTickets = async ({ queryKey }: any) => {
	...
	const response = await CustomerTicketService.get_all_customer_tickets(
		params
	);
...
export default function CustomerTickets() {
	...
	const [searchCustomerTicketSuccess, setSearchCustomerTicketSuccess] =
		useState("");
	const [searchCustomerTicketPending, setSearchCustomerTicketPending] =
		useState("");
	const [searchCustomerTicketOngoing, setSearchCustomerTicketOngoing] =
		useState("");
	const [searchCustomerTicketFailed, setSearchCustomerTicketFailed] =
		useState("");
	...
	console.log(
		"allCustomerTicketQueryRes.data : ",
		allCustomerTicketQueryRes.data
	);

	const allCustomerTicketSuccessQueryRes = useQuery({
		queryKey: [
			"allCustomerTicketSuccess",
			{ status: "SUCCESS" },
			searchCustomerTicketSuccess,
		],
		queryFn: getAllCustomerTickets,
		onError: (err) => {
	...
	console.log(
		"allCustomerTicketSuccessQueryRes.data : ",
		allCustomerTicketSuccessQueryRes.data
	);

	const allCustomerTicketPendingQueryRes = useQuery({
		queryKey: [
			"allCustomerTicketPending",
			{ status: "PENDING" },
			searchCustomerTicketPending,
		],
		queryFn: getAllCustomerTickets,
		onError: (err) => {
	...
	console.log(
		"allCustomerTicketPendingQueryRes.data : ",
		allCustomerTicketPendingQueryRes.data
	);

	const allCustomerTicketOngoingQueryRes = useQuery({
		queryKey: [
			"allCustomerTicketOngoing",
			{ status: "ONGOING" },
			searchCustomerTicketOngoing,
		],
		queryFn: getAllCustomerTickets,
		onError: (err) => {
	...
	console.log(
		"allCustomerTicketOngoingQueryRes.data : ",
		allCustomerTicketOngoingQueryRes.data
	);

	const allCustomerTicketFailedQueryRes = useQuery({
		queryKey: [
			"allCustomerTicketFailed",
			{ status: "FAILED" },
			searchCustomerTicketFailed,
		],
		queryFn: getAllCustomerTickets,
		onError: (err) => {
	...
	console.log(
		"allCustomerTicketFailedQueryRes.data : ",
		allCustomerTicketFailedQueryRes.data
	);

	return (
		<Layout title={"Requêtes Clients"}>
			<>
					...
					<Tabs defaultValue="pending" className="w-full">
						...
						<div className={`mt-5`}>
							<TabsContent value="all">
								<CustomerTicketAll
									isLoading={
										allCustomerTicketQueryRes.status ==
										"loading"
									}
							...
							<TabsContent value="success">
								<CustomerTicketSuccess
									isLoading={
										allCustomerTicketSuccessQueryRes.status ==
										"loading"
									}
							...
							<TabsContent value="failed">
								<CustomerTicketFailed
									isLoading={
										allCustomerTicketFailedQueryRes.status ==
										"loading"
									}
							...
							<TabsContent value="pending">
								<CustomerTicketPending
									isLoading={
										allCustomerTicketPendingQueryRes.status ==
										"loading"
									}
							...
							<TabsContent value="ongoing">
								<CustomerTicketOngoing
									isLoading={
										allCustomerTicketOngoingQueryRes.status ==
										"loading"
									}
