...
const handleBlock = async (queryData:any) => {
    ...
    const response = await UserService.block_user_account({
...
export default function BlockUserAccountModalForm({customer}:TransferModalProps) {
    ...
    const mutation = useMutation({
		mutationFn: (data)=>handleBlock({currentUserId:currentUser?._id, customerId:customer?._id, body:data}),
		onError: (err:any) => {
            console.error("onError : ", err.message);
            toast.error(`Erreur lors du blocage du compte : ${err.message}`);		
		},
		onSuccess: (data) => {
            console.log("onSuccess : ", data);
            toast.success(`Blocage du compte effectué avec succès`);
