...
import { selectCardPayments, selectCardPurchases } from "@/redux/slices/card";
...
export default function Index({isLoading, search, setSearch}:Props) {
	...
	// dispatch(setSearchConcern('cardPurchases'));
	const transactionsData:any = useSelector(selectCardPurchases);
