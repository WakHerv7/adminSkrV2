...
import { setTrxAll, setTrxPending, setTrxSuccess, setTrxFailed } from "@/redux/slices_v2/nairapay";
...
const getAllTrx = async ({queryKey}:any) => {
  ...
  const response = await NairapayService.get_all_trxs(params);
      ...
      <section className="my-10">
          <Tabs defaultValue="pending" className="w-full">
            ...
            <TabsList className="TabsList">
              ...
              <TabsTrigger className="TabsTrigger" value="success">Réussis</TabsTrigger>
              <TabsTrigger className="TabsTrigger" value="failed">Echoués</TabsTrigger>
            ...
            <div className={`mt-5`}>
              ...
              <TabsContent value="success">
                <TrxSuccess
                isLoading={allTrxSuccessQueryRes.status == 'loading'}
              ...
              <TabsContent value="failed">
                <TrxFailed
                isLoading={allTrxFailedQueryRes.status == 'loading'}
              ...
              <TabsContent value="pending">
                <TrxPending
                isLoading={allTrxPendingQueryRes.status == 'loading'}
