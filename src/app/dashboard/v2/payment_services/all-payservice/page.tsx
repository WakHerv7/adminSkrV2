...
const getAllTrx = async ({ queryKey }: any) => {
	...
	params.includedCategories = "service";
	params.includedTypes =
		"cashin-cashin.cashout-cashout.topup-airtime.topup-data.topup-electricity.topup-water.subscription-electricity.subscription-water.subscription-cnps.subscription-sabc.subscription-guinness.subscription-corporate.product-canal.product-easytv.product-dstv.product-startimes.product-cable_tv.product-ticket.product-shirt.product-products_services.bill-electricity.bill-water.bill-electricity_water_bills.bill-cnps.bill-customs.bill-kribiterminal.bill-taxes.bill-tax_government.";
...
export default function Index() {
	useTitle("Card | Payment Fees", true);
	...
	return (
		<Layout title={"Services factures et credit communication"}>
			<>
