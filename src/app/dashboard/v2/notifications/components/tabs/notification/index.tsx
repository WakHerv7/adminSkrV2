...
const Notification = () => {
  ...
  console.log("allNotificationsQueryRes.data : ", allNotificationsQueryRes?.data);
  
  

  const rearrangedTableData = allNotificationsQueryRes?.data?.map((item:any, index:any) => {
    let customersList = '';
      ...
      <div className='mt-7'>
        ...
        <div className='mt-4'>
          <CustomTable
            ...
            isLoading={!allNotificationsQueryRes?.data && allNotificationsQueryRes.status === 'loading'}
            // btn={<CButton
